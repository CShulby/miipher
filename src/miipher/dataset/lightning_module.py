...
class MiipherLightningModule(LightningModule):
    ...
    def on_fit_start(self):
        print("on_fit_start: Moving feature extractor to device")
        self.feature_extractor.to(self.device)
        print("on_fit_start: Feature extractor moved")
    ...
    print(f"Starting training_step for batch index: {batch_idx}")
    try:
        (
            phone_feature,
            speaker_feature,
        ...
        print("Shape of phone_feature:", phone_feature.shape)
        print("Shape of speaker_feature:", speaker_feature.shape)
        print("Shape of degraded_ssl_feature:", degraded_ssl_feature.shape)
        print("Shape of clean_ssl_feature:", clean_ssl_feature.shape)
